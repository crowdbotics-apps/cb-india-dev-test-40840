"""
Django settings for cb_india_dev_test_40840 project.
...
ROOT_URLCONF = 'cb_india_dev_test_40840.urls'
...
WSGI_APPLICATION = 'cb_india_dev_test_40840.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cb_india_dev_test_40840 API",
    "DESCRIPTION": "API documentation for cb_india_dev_test_40840 App",
    "VERSION": "v1",
}
